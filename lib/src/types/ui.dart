...
class CameraTargetBounds {
  ...
  /// 转换成json对象
  List<List<List<double>>> toJson() => <List<List<double>>>[
        if (bounds?.toJson() != null) bounds!.toJson()!,
      ];
...
class MyLocationStyleOptions {
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      'enabled': enabled,
      'circleFillColor': circleFillColor?.value,
      'circleStrokeColor': circleStrokeColor?.value,
      'circleStrokeWidth': circleStrokeWidth,
      'icon': icon?.toMap(),
    }..removeAllEmptyEntry();
  }
